...
(function () {
  ...
  const PRODUCTS = [
    ...
    { id: "bank", name: "Bank Rails", tag: "Move money in & out", short: "Move dollars in and out by bank transfer via ACH or RTP.", plain: "Pull dollars in by ACH to buy crypto, and send dollars out by ACH, RTP or FedNow when customers cash out. Bank linking is handled through Plaid.", src: "fiat" },
