---
title: "Commissions, Fees and Tiering"
---
...
- [`POST /clob/accounts`](https://docs.zerohash.com/reference-link/post_clob-accounts)
- [`PATCH /clob/accounts`](https://docs.zerohash.com/reference-link/patch_clob-accounts)
