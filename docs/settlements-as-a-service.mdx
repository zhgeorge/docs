---
title: "Settlements as a Service"
---
...
- **Regulatory umbrella:** zerohash is a registered Money Service Business and FX Dealer with FinCEN, and [money transmitter in all 50 states across the U.S.](/docs/permitted-and-restricted-jurisdictions) This infrastructure can be leveraged by Platforms who want to avoid the regulatory investment and resulting overhead.
...
- [POST /trades](https://docs.zerohash.com/reference-link/post_trades)
- [GET /trades](https://docs.zerohash.com/reference-link/get_trades-trade-id)
- [GET /trades/:id](https://docs.zerohash.com/reference-link/get_trades-trade-id)
...
Review our code recipe for more insight on trade submission to the [POST /trades](https://docs.zerohash.com/reference-link/post_trades) endpoint .
