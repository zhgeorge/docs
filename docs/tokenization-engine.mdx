...
description: "Tokenization Engine Integration Guide"
---
...
- For fungible tokens: 1:1 fiat-backed stablecoins, high-volume transfers, and DeFi protocol integration → Refer to the [Fungible Token Integration Guide](/docs/fungible-token-11-stablecoin-integration)
- For non-fungible tokens: Unique asset tokenization, loan and debt instruments, or collectibles and certificates → Refer to the [Non-Fungible Token Integration Guide](/docs/non-fungible-token-nft-integration)
