---
title: "Request and Execute Quotes"
---
...
> Endpoint: [`POST /liquidity/rfq`](https://docs.zerohash.com/reference-link/post_liquidity-rfq)
...
> Endpoint`POST /liquidity/execute`
...
> Endpoint: [`GET /trades`](https://docs.zerohash.com/reference-link/get_trades)
...
- Platforms defined limits must fall within the constraints listed in the [RFQ Supported Assets page](/docs/supported-instruments-1).
