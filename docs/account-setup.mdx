---
title: "Account Activation & Funding Models"
---
...
- A participant must be created, associated to your platform. You can create a participant on the zerohash system using the following endpoints;
  ...
  - [`POST /participants/entity/new`](https://docs.zerohash.com/reference-link/post_participants-entity-new) to create a new Entity(*NNP*) participant.
