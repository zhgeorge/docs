---
title: "CREATE2 Smart Contract-Powered Address Deployments"
description: "zerohash uses CREATE2 Smart Contracts to predictively deploy on-chain addresses only once a deposit is confirmed"
---
...
CREATE2 has been added to both the [Fund API](/docs/fund-integration-guide-api) and the [Fund SDK](/docs/fund-integration-guide-sdk).
