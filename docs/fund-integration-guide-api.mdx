...
In this guide, the Platform is [setup](/docs/fund-overview#setup) to use the **Onboarding API (Reliance)** plus the **Account** **Funding API**.
...
See [Account Funding Transaction Updates](https://docs.zerohash.com/reference/fund-transaction-update) for a full list of webhooks.
...
Example response - [GET /movements?parent\_link\_id=](https://docs.zerohash.com/reference-link/get_accounts-account-id-movements)
