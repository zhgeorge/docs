...
You can query balances via the [GET /accounts](https://docs.zerohash.com/reference-link/get_accounts) endpoint. In order to pick out the float account, use the following query parameters
