...
- **SDK:** [Onboarding SDK](/docs/onboarding-experience-sample)
...
The platform should follow the participant same onboarding instructions mentioned on [this guide](/docs/customer-accounts-guide#account-types).
