---
title: "W-8 Implementation Guide - API"
description: "Guide to providing relevant W-8 details during user onboarding"
---
...
zerohash supports the generation of certified W-8BEN and W-8BEN-E forms via API. In the majority of cases, these two forms will be sufficient to cover your customer demographic, along with the [W-9](/docs/w-9-implementation-guide).
...
- Provide all treaty information as it relates to the `country` of the `treaty_claim` and any `withholding_rate` being claimed
