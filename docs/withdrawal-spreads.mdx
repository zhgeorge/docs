---
title: "Withdrawal Spreads"
description: "This page describes monetization options available on withdrawals"
---
...
Note that there may be limits or caps in-place depending on the jurisdiction such as NY. See [Custom Spreads](/docs/custom-spreads) for more information.
...
- See this guide on [Custom Spreads](/docs/custom-spreads#technical-notes) for additional information on applying custom spreads to convert\_withdraw transactions.
