---
title: "Supported Instruments (RFQ)"
description: "All assets below are supported within the US."
---

To programmatically retrieve the latest instruments available for Request for Quote (RFQ) trading, you can query the [`GET /assets`](https://docs.zerohash.com/reference-link/get_assets) endpoint. In the response, look for assets where `"rfq_liquidity_enabled": true`, this field indicates whether the asset is currently supported for RFQ trading.
...
| ETH.ROBINHOOD/USD | ETH.ROBINHOOD | USD | 16 | 18 | 0.02 | 500,000.00 |
...
| USDG.ETH/USD | USDG.ETH | USD | 2 | 6 | 0.01 | 500,000.00 |
| USDG.ROBINHOOD/USD | USDG.ROBINHOOD | USD | 2 | 6 | 0.01 | 500,000.00 |
| USDG.SOL/USD | USDG.SOL | USD | 2 | 6 | 0.01 | 500,000.00 |
...
| Symbol | Underlying Asset | Quoted Currency | RFQ Price Precision | RFQ Quantity Precision | RFQ Min Trade Notional | RFQ Max Trade Notional |
| --- | --- | --- | --- | --- | --- | --- |
| ADA/USDC.ETH | ADA | USDC.ETH | 16 | 6 | 0.02 | 500,000.00 |
| AVAX/USDC.ETH | AVAX | USDC.ETH | 16 | 18 | 0.02 | 500,000.00 |
| BCH/USDC.ETH | BCH | USDC.ETH | 16 | 8 | 0.02 | 500,000.00 |
| BNB/USDC.ETH | BNB | USDC.ETH | 16 | 18 | 0.02 | 500,000.00 |
| BTC/USDC.ETH | BTC | USDC.ETH | 6 | 8 | 0.02 | 500,000.00 |
| DOGE/USDC.ETH | DOGE | USDC.ETH | 16 | 8 | 0.02 | 500,000.00 |
| ETH/USDC.ETH | ETH | USDC.ETH | 16 | 18 | 0.02 | 500,000.00 |
| HBAR/USDC.ETH | HBAR | USDC.ETH | 16 | 8 | 0.02 | 500,000.00 |
| LINK.ETH/USDC.ETH | LINK.ETH | USDC.ETH | 2 | 18 | 0.02 | 500,000.00 |
| LTC/USDC.ETH | LTC | USDC.ETH | 16 | 8 | 0.02 | 500,000.00 |
| PEPE.ETH/USDC.ETH | PEPE.ETH | USDC.ETH | 16 | 18 | 0.02 | 500,000.00 |
| SHIB.ETH/USDC.ETH | SHIB.ETH | USDC.ETH | 16 | 18 | 0.02 | 500,000.00 |
| SOL/USDC.ETH | SOL | USDC.ETH | 16 | 9 | 0.02 | 500,000.00 |
| SUI/USDC.ETH | SUI | USDC.ETH | 16 | 9 | 0.02 | 500,000.00 |
| TRX/USDC.ETH | TRX | USDC.ETH | 16 | 6 | 0.02 | 500,000.00 |
| XRP/USDC.ETH | XRP | USDC.ETH | 16 | 6 | 0.02 | 500,000.00 |
