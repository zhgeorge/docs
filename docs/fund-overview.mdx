...
description: "Instantly fund an account anytime, anywhere"
---
...
<Note title="Account Funding is available for both US and EU Platforms.">
...
We offer webhooks specific to this product. See details here: [Account Funding Webhook](https://docs.zerohash.com/reference-link/fund-transaction-update)
