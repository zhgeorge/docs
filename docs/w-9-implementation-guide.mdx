---
title: "W-9 Implementation Guide - API"
description: "Guide to providing relevant W-9 details during user onboarding"
---
...
And you're done. Make sure to do this for pre-existing customers and on an ongoing basis for new customers. If any taxpayer PII changes with respect to their W-9 form data, please ensure that a new W-9 is passed to zerohash via the same endpoint as above.
...
Please reference the below descriptions on each of the new W-9 fields listed above and what they mean. For additional information on W-8 support, please see the implementation guide [here](/docs/w-8-implementation-guide-api).
