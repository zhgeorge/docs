...
In this guide, the Platform is [setup](/docs/fund-overview#setup) to use the zerohash **Onboarding SDK (KYC as a Service)** with the zerohash **Account Funding SDK**. Both SDKs are hosted on web-sdk.zerohash.com
...
In this guide, the Platform is [setup](/docs/fund-overview#setup) to use the zerohash europe B.V. **Onboarding SDK (KYC as a Service)** with the zerohash europe B.V. **Account Funding SDK**. Both SDKs are hosted on web-sdk.zerohash.eu.
