...
<Info title="Adding or Removing Advisors After Account Creation">
...
<Info title="Advisor Permissions">
...
- Details on advisor authorization process here: [https://docs.zerohash.com/docs/financial-advisor-authorization](/docs/financial-advisor-authorization)
