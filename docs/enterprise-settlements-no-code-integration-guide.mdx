---
title: "Modular Payouts No-Code Integration Guide"
description: "Fiat-to-stablecoin settlements with zero engineering effort"
---
...
| conversion\_currency | USDC.BASE | The cryptocurrency to be used for the payout. Must be a [valid asset](/docs/supported-assets-instruments)that zerohash supports. |
