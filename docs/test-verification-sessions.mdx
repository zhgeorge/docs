---
title: "Test verification sessions"
description: "Recommendations and helpful tips for testing the KYC experience in the zerohash SDK."
---
...
| Field | Input |
| --- | --- |
| Email | Any actual email (e.g. [first.last+1@domain.com](mailto:first.last+1@domain.com) )<br />*Note: Email uniqueness required so you can use +1, +2, etc. to simulate* |
...
<Info title="Note for production">
