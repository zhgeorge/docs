...
description: "Common error HTTP status codes Status Code Description Remediation Steps 400 Bad Request The server could not understand the request, most likely due to invalid syntax. Please check if the request…"
---
