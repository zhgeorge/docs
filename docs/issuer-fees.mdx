...
Depending on the Platform's flow, the above fee schedule may not apply. Consult with your zerohash representative to align your setup.
...
- Assume the fee schedule mentioned in the [above table](/docs/issuer-fees#issuer-fee-schedule)
...
## Account Funding API Flow (Fee Payor: Platform)
