---
title: "Submit First API Call"
description: "Establish connectivity to our services"
---
...
- A zerohash Cert or Prod platform. See [Get Platform Access](/docs/get-platform-access)
...
Execute a [Get server time](https://docs.zerohash.com/reference-link/get_time) request
...
See [API Authentication](/docs/authentication) for the full signing recipe.
