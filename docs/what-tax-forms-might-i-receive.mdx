...
*Note:* Cost basis will only be provided for assets purchased via zerohash.
...
The US tax form 1099-DA provides transactional information detailing gains and losses from disposing of assets. At this time, cryptocurrency is classified as property (a capital asset). The information on Form 1099-DA helps you fill out Schedule D and Form 8949.
...
If you engaged in qualifying transactions on a platform that is using zerohash's Tax as a Service (TaaS) product, and met any requisite thresholds to receive a tax form, then you'll have the relevant forms delivered to you.
...
All forms are delivered to platforms via SFTP to distribute to end users.
