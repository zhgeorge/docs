---
title: "Participant and Account Statuses and Locking"
description: "Participant Status Definitions Status Definition submitted Successfully submitted to <POST /participants/customers/new> and given a participant code, but has not yet been approved to transact.…"
---
