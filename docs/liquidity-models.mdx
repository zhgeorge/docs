...
| --- | --- | --- |
| Standard (Default) | Yes | Platform's Reserve Account - [PlatformCode]/00SCXM/general |
| Novated | No | Platforms Float Account - 00SCXM/[PlatformCode]/general |
| Direct | No | End Customer Account - [ParticipantCode]/[PlatformCode]/general |
