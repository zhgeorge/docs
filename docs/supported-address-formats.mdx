---
title: "Supported Address Formats"
---
...
- **Cash Addresses:** The zerohash PROD environment supports the [CashAddr](/docs/which-bitcoin-cash-bch-chain-do-you-support) BCH address format. This address format is designed to help distinguish between BCH and BTC more clearly.
