---
title: "Modular Payouts SDK Integration Guide"
...
| Payor | An optional participant in the flow. If omitted, the Platform will take the role of the Payor. A non-natural person (typically a business) that is a customer of the Platform. This is the core front-end that the Beneficiary interacts with. |
...
<Info title="You can see the full integration guide for Withdrawals on the link below">
