---
title: "Account Link SDK + Withdraw SDK Guide"
description: "Platforms can use the Account Link SDK and Withdraw SDK together to allow their End Customers to link an external account and then subsequently withdraw funds to it."
---
...
The [Fund Withdrawals SDK](https://docs.zerohash.com/reference/fund-withdrawals-1) is also an embeddable widget that allows End Customers to trigger the withdrawal to their linked crypto wallet.
...
<Info>
### You can see the full integration guide for Withdrawals here.
</Info>
