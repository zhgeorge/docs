...
2. User auto-creation (SCIM provisioning) is not supported at this time. Follow the steps [here](/docs/how-to-add-user) to invite a new user to join the participant account. The new user can then log in with their SSO credentials.
