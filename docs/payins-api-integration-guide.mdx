...
<Info title="Signature Collection">
...
If the Shopper (`SHOPP1`) has **insufficient** PII data for the [Shopper Tier](/docs/onboard-shoppers)required for the transaction, [POST /pay/rfq](https://docs.zerohash.com/reference/post_pay-rfq-1) will return an error message identifying missing requirements:
