---
title: "Memos, Destination Tags & Messages"
---
...
*For deposits of tag-based assets to zerohash, the memo, destination tag or message is required. This rule ALSO applies to any token that uses that base chain such as a USDC asset on a tag or memo based blockchain.*
...
For more details on these assets, you can check the [Supported Assets & Instruments](/docs/supported-assets-instruments) page.
...
If you run [GET /deposits/digital\_asset\_addresses](https://docs.zerohash.com/reference-link/get_deposits-digital-asset-addresses) endpoint on any of memo/destination/message tagged based assets in the above list, you will see the below response:
...
![](https://files.readme.io/0abc1bf-image.png)

![](https://files.readme.io/0591b8d-image.png)

## Create a Withdrawal request via API.

1. When using request [POST /withdrawals/requests](https://docs.zerohash.com/reference-link/post_withdrawals-requests) endpoint with a defined withdrawal address, two related request parameters need to be used to provide the additional information for those assets:
...
- [Deposits](https://docs.zerohash.com/reference-link/deposits)
- [Withdrawals](https://docs.zerohash.com/reference-link/withdrawals)
- [Convert and Withdraw](https://docs.zerohash.com/reference-link/convert-and-withdraw)
