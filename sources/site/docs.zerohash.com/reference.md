# Source: https://docs.zerohash.com/reference
...
1. To build a signature, you need to concatenate the **timestamp**+**method**+**route**+**request body** values of your request to a string.
 ...
 1. A request to the [GET /accounts](https://docs.zerohash.com/reference-link/get_accounts). 
 ...
 2. A request to the [POST /convert\_withdraw/execute](https://docs.zerohash.com/reference-link/post_convert-withdraw-execute)
